    ...
    return (
      <div className="body flex">
        <Card
          name={"Adam Martin"}
          img={AdamImg}
          commits={this.state.adam}
          issues={this.state.adamIssues}
          bio={"I am the kangaroo whisperer"}
        />
        <Card
          name={"Abhi Velaga"}
          img={AbhiImg}
          commits={this.state.abhi}
          issues={this.state.abhiIssues}
          bio={"Man with the minivan"}
        />
        <Card
          name={"Jason Moy"}
          img={JasonImg}
          commits={this.state.jason}
          issues={this.statejasonIssues}
          bio={"I love snow"}
        />
        <Card
          name={"Faezah Ali"}
          img={FaezahImg}
          commits={this.state.faezah}
          issues={this.state.faezahIssues}
          bio={"Wrote my page with the flu. The best players play hurt."}
        />
        <Card
          name={"Gavin Rodrigue"}
          img={GavinImg}
          commits={this.state.gavin}
          issues={this.state.gavinIssues}
          bio={"The mustache speaks for itself"}
        />
      </div>
    );
  }
